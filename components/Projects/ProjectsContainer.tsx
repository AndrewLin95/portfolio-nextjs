...
const ProjectsContainer: FC<Props> = ({ data }) => {
  return (
    <div className="flex md:flex-row w-full xxs:flex-col ">
      <img
      ...
      />
      <ScrollParallax>
        <div className="flex flex-col w-full relative md:right-36 md:bottom-0 sm:-right-10 sm:bottom-16 xs:bottom-8">
